...
var CanvasRenderer = /** @class */ (function (_super) {
    ...
    CanvasRenderer.prototype.mask = function (paths) {
        ...
        this.ctx.lineTo(0, 0);
        this.ctx.restore();
        this.formatPath(path_1.reversePath(paths));
        this.ctx.closePath();
    };
                                ...
                                switch (_h.label) {
                                    ...
                                    case 5:
                                        if (image_1.isLinearGradient(backgroundImage)) {
                                            ...
                                            gradient_1.processColorStops(backgroundImage.stops, lineLength || 1).forEach(function (colorStop) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        this.ctx.restore();
                        borderBoxArea_1 = bound_curves_1.calculateBorderBoxPath(paint.curves);
                        styles.boxShadow
                            .slice(0)
                            .reverse()
                            ...
                            _this.ctx.fillStyle = color_1.asString(shadow.color);
